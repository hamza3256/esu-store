...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        ...
        var user, productIds, payload, products, filteredProductsHavePrice, order, line_items, stripeSession, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    filteredProductsHavePrice = products.filter(function (product) {
                    ...
                    return [4 /*yield*/, payload.create({
                            ...
                            data: {
                                _isPaid: false,
                                products: filteredProductsHavePrice.map(function (product) { return product.id; }),
                                user: user.id,
                            },
                        })];
                case 3:
                    order = _c.sent();
                    line_items = [];
                    filteredProductsHavePrice.forEach(function (product) {
                        line_items.push({
                ...
                case 4:
                    ...
                    return [4 /*yield*/, stripe_1.stripe.checkout.sessions.create({
                            success_url: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/order-confirmation?orderId=").concat(order.id),
                ...
                case 6:
                    error_1 = _c.sent();
                    console.log("Error creating stripe payment session:" + error_1);
